const gridWrapperAttributes = document.getElementById('grid-attributes');

if (gridWrapperAttributes) {
  ...
  }).render(gridWrapperAttributes);

  // Evento para manejar el botón EDITAR
  gridWrapperAttributes.addEventListener('click', function (e) {
