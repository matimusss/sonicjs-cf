const gridWrapperOrders = document.getElementById('grid-orders');

if (gridWrapperOrders) {
  ...
  }).render(gridWrapperOrders);

  // Evento para manejar el botón EDITAR
  gridWrapperOrders.addEventListener('click', function (e) {
