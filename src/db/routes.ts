...
import * as attribute_values from './schema/ecommerce/attribute_values';
import * as attributes from './schema/ecommerce/attributes';
import * as countries from './schema/ecommerce/countries';
import * as coupons from './schema/ecommerce/coupons';
import * as gallery from './schema/ecommerce/gallery';
import * as notifications from './schema/ecommerce/notifications';
import * as order_items from './schema/ecommerce/order_items';
import * as order_statuses from './schema/ecommerce/order_statuses';
import * as orders from './schema/ecommerce/orders';
import * as product_attribute_values from './schema/ecommerce/product_attribute_values';
import * as product_attributes from './schema/ecommerce/product_attributes';
import * as product_categories from './schema/ecommerce/product_categories';
import * as product_coupons from './schema/ecommerce/product_coupons';
import * as product_shipping_info from './schema/ecommerce/product_shipping_info';
import * as product_suppliers from './schema/ecommerce/product_suppliers';
import * as product_tags from './schema/ecommerce/product_tags';
import * as products from './schema/ecommerce/products';
import * as sells from './schema/ecommerce/sells';
import * as shipping_country_zones from './schema/ecommerce/shipping_country_zones';
import * as shipping_rates from './schema/ecommerce/shipping_rates';
import * as shipping_zones from './schema/ecommerce/shipping_zones';
import * as suppliers from './schema/ecommerce/suppliers';
import * as tags from './schema/ecommerce/tags';
import * as variant_options from './schema/ecommerce/variant_options';
import * as variant_values from './schema/ecommerce/variant_values';
import * as variants from './schema/ecommerce/variants';
import * as categories from './schema/ecommerce/categories';
