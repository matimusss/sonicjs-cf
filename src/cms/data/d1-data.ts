...
export async function getProduct(db, id) {
    ...
    -- Agrupación de atributos del producto
    json_group_array(
        json_object(
    ...
    -- Agrupación de detalles de variantes
    json_group_array(
        json_object(
            ...
            -- Agrupación de atributos de variantes en una subconsulta
            (
    ...
    -- Agrupación de etiquetas del producto
    json_group_array(
        json_object(
            'tag_name', t.tag_name,
            'tag_icon', t.icon
